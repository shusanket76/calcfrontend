...
const SimpsonEvaluate = () => {
  ...
  const handlesubmit = async () => {
    const url = "https://web-production-025a.up.railway.app/simpson";
  ...
  const handlesubmit1 = async () => {
    const url1 = "https://web-production-025a.up.railway.app/simpsonFbound";
  ...
  const handlesubmit2 = async () => {
    const url1 = "https://web-production-025a.up.railway.app/simpsonError";
    const response = await axios.post(url1, {
      function: latex,
  ...
  const handlesubmit3 = async () => {
    const url1 = "https://web-production-025a.up.railway.app/simpsonInterval";
    const response = await axios.post(url1, {
      function: latex,
      k: k,
      error: error,
