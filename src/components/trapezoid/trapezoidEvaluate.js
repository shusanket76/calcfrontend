...
const TrapezoidEvaluate = () => {
  ...
  const handlesubmit = async () => {
    const url = "https://web-production-025a.up.railway.app/trapezoid";
  ...
  const handlesubmit1 = async () => {
    const url1 = "https://web-production-025a.up.railway.app/trapezoidFbound";
  ...
  const handlesubmit2 = async () => {
    const url1 = "https://web-production-025a.up.railway.app/trapezoidError";
    const response = await axios.post(url1, {
      function: latex,
  ...
  const handlesubmit3 = async () => {
    const url1 = "https://web-production-025a.up.railway.app/trapezoidInterval";
    const response = await axios.post(url1, {
      function: latex,
